...
class MapSelectorBuilder {
  ...
  static #Selector = class {
    ...
    update() {
      ...
      this.#sendEvent('Districts', new MapSelectorBuilder.#StateEvent(district_events));      
      this.#sendEvent('Precincts', new MapSelectorBuilder.#StateEvent(precinct_events));
      this.#sendEvent('Statewide', new MapSelectorBuilder.#StatewideEvent(statewide));
    }
